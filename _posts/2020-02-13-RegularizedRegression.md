...
**Naive Bayes** <br />
To conclude [Naive Bayes](https://en.wikipedia.org/wiki/Naive_Bayes_classifier), it is a simple but powerful equation that could combine prior (The knowledge you know before building the model etc hypothesis sets) and likelihood (The parameters likelihood comes from observations). Where the formula is defined as:
![Naive Bayes](https://github.com/superp0tat0/superp0tat0.github.io/raw/master/files_posts/post2/naive_bayes.png)
