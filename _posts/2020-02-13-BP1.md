---
title: 'How Ridge/Lasso Regression could solve overfit?'
date: 2020-02-13
...
```
Then create our model class for fitting and visualization, here we only use Ridge regression (polynomial regression with l2 regulizer):
```
class Demo_model:
