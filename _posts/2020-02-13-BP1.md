...
&= argmax_{\beta}(-\sum_{i=1}^{n} \frac{1}{2 \sigma^2}\left | y_i - \beta x_i \right |{2}^{2} - \frac{\lambda}{2}\left | \beta \right |{2}^{2} + C) &\\ 
&= argmin_{\beta}(\sum_{i=1}^{n} \frac{1}{\sigma^2}\left | y_i - \beta x_i \right |{2}^{2} + \lambda \left | \beta \right |{2}^{2} + C)
\end{align*}
